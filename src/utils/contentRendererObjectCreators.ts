...
export function secondaryTitleCreator({ content }: Omit<ISecondaryTitle, "type">): ISecondaryTitle {
  return {
...
export function primaryTitleCreator({ content }: Omit<IPrimaryTitle, "type">): IPrimaryTitle {
  return {
...
export function paragraphCreator({ content }: Omit<IParagraph, "type">): IParagraph {
  return {
...
export function bulletListCreator({ bulletListItems }: Omit<IBulletList, "type">): IBulletList {
  return {
...
export function blockRendererCreator({ blockHeading, leftNode, rightNode }: Omit<IBlockRenderer, "type">): IBlockRenderer {
  return {
...
export function headingWithUnderlineCreator({ content }: Omit<IHeadingWithUnderline, "type">): IHeadingWithUnderline {
  return {
...
export function blockHeaderCreator({ content }: Omit<IBlockHeader, "type">): IBlockHeader {
  return {
