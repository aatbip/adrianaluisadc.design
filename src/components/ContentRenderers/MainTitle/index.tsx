...
export const MainTitle = (props: IMainTitle) => {
  ...
  return (
    ...
    >
      <TypographyVariation1 variant="heading3">
        {props.title}
      </TypographyVariation1>
      <Stack direction="row" columnGap={7.5} m="40px 0px 24px 0px">
        {props.ctaButton1Content && props.ctaButton1Link && (
          <CTAButton
            content={props.ctaButton1Content}
            handleClick={() => {
              openLink(props.ctaButton1Link);
            }}
          />
        )}
        {props.ctaButton2Content && props.ctaButton2Link && (
          <CTAButton
            content={props.ctaButton2Content}
            handleClick={() => {
              openLink(props.ctaButton2Content);
            }}
          />
        )}
      </Stack>
