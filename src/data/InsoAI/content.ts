...
export const content: IContent = [
  mainTitleCreator({
    ...
    ctaButton1Link:
      "https://www.figma.com/proto/wG6SEadmUL6CF5bLcSvATE/DESIGN-HANDOFF-(Copy)-(Copy)?page-id=8%3A72138&node-id=8-76386&viewport=680%2C776%2C0.12&t=33VXokkuh5GRMqCE-1&scaling=min-zoom&starting-point-node-id=8%3A76386&show-proto-sidebar=1",
  ...
  blockRendererCreator({
    ...
    rightNode: [
      ...
      paragraphCreator({
        content:
          "1 How might we offer major services without hiding other services?",
      }),
      paragraphCreator({
      ...
      paragraphCreator({
        content:
          "3 How might we get hotel, tour guiding, and vehicles data without depending on API Providers?",
      }),
    ],
  }),
  ...
  paragraphCreator({
    content:
      "We are given a couple of hours each to create a mid-fidelity wireframes of our solutions with the given HMWs. This is then posted in our art museum board anonymously to have a non-bias environment during the feedback and voting session.",
  }),

  paragraphCreator({
    content:
      "We each gave critique on every solution on the board through adding post-it stickies. Every one of us was given the chance to cast our voting and share why we liked a specific feature on a solution sketch or find a solution problematic by giving a minute of presentation",
  }),
  ...
  paragraphCreator({
    content:
      "The decider or the person with highest stake on the product, where on this case is our founder, casted the final decision and voted on the final solution concept, and two features that should be in our product.",
  }),
  ...
  paragraphCreator({
    content:
      "The concept decided was to have a simple and clean interface that could easily be navigated by users by providing minimal fields. In this case, it was discussed to have a sticky sidebar for users to go to different sections or filtering function while being able to scroll infinitely of the different products offered and also the easy filterization procedure on the searching process.",
  }),
  ...
  paragraphCreator({
    content:
      "The Sticky Services Navigation Feature made the problem of easily making the end-users know the services offered by Nepal Air Trip at one swipe and scan. This helps to also have a navigation of different services faster and easier for users.",
  }),
