...
export const content: IContent = [
  ...
  paragraphCreator({
    content: "Timeout is a mobile application designed for time travelers who wants to travel to the past and future. This project was my entry for the UX Protothon 2024 Space & Time Travel Track, hosted by Dubstech at the University of Washington in collaboration with Design Buddies."
  }),
  ...
  paragraphCreator({
    content: "Timeout was selected as the 2nd Place Winner from over 600+ participants worldwide, judged by industry experts from Adobe, Oracle, Career Coach, and Universal Audio. Remarkably, it was the only winning entry designed by a solo participant."
  }),
  ...
  paragraphCreator({
    content: "The user journey within the time travel app for architecture students is carefully crafted to provide a comprehensive and engaging learning experience. From the moment students open the app, they are guided through a curated selection of historical architectural landmarks and periods, allowing them to explore different styles, techniques, and influences from around the world."
  }),


  paragraphCreator({
    content: "The journey is structured in a way that encourages active participation and critical thinking, with interactive elements and in-depth historical context provided at each destination. Overall, the user journey effectively immerses students in the rich tapestry of architectural history and encourages them to develop a deeper appreciation for the built environment."
  }),
  ...
  paragraphCreator({
    content: "The UI design of the app is sleek, modern, and user-friendly, providing architecture students with intuitive navigation and access to a wealth of educational content. The app's interface is designed to showcase the beauty and complexity of architectural landmarks, with high-quality images, detailed diagrams, and interactive 3D models that allow students to explore each structure from every angle. The use of clean typography, cohesive color schemes, and minimalist design elements enhances the overall usability and aesthetic appeal of the app, making it easy for students to focus on learning and discovery."
  }),
